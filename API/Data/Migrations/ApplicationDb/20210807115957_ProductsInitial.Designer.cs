...
namespace API.data.migrations.applicationdb
{
    ...
    [Migration("20210807115957_ProductsInitial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.ProductModels.ProductControlClass", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Models.ProductModels.ProductNoPublicity", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Models.ProductModels.ProductsGroupThirdProduct", b =>
                {
                    ...
                    b.ToTable("ProductsGroupThirdProduct");
                });
            ...
            modelBuilder.Entity("API.Models.ProductModels.Product", b =>
                {
                    b.HasOne("API.Models.ProductModels.ProductControlClass", null)
                        .WithMany("Products")
